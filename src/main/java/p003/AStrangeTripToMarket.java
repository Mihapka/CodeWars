...
public class AStrangeTripToMarket {
    ...
    wonder what kind of algorithm you could use to shift octaves by 8 pitches or something silly like that, it
    dawns on you that you have been watching the musician for some 10 odd minutes. You ask, "how much do
    people normally tip for something like this?" The artist looks up. "It's always gonna be about tree fiddy."
    ...
    Since you are tired of being grifted by this monster, the time has come to code a solution for finding The
    Loch Ness Monster. Note that the phrase can also be written as "3.50" or "three fifty".*/
    public static void main(String[] args) {
        ...
        System.out.println(isLockNessMonster(" Your girlscout cookies are ready 3.50"));
        System.out.println(isLockNessMonster("dskjbsfn three fifty"));
    }
