...
public class HowManyStairs {
    /*Suzuki is a monk who climbs a large staircase to the monastery as part of a ritual. Some days he
    climbs more stairs than others depending on the number of students he must train in the morning. He is
    curious how many stairs might be climbed over the next 20 years and has spent a year marking down his daily
    progress.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(54636040);
    }

    public static long stairsIn20(int[][] stairs) {

        IntStream intStream = Arrays.stream(stairs).flatMapToInt(Arrays::stream);
        long sum = intStream.sum() * 20L;
        return sum ;
